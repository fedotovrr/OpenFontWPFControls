...
namespace OpenFontWPFControls.Layout
{
    public class StructuralTextItem
    {
        ...
        public GlyphPoint this[int index] => GetLayout().GlyphPoints[index];

        public int GlyphsCount => GetLayout().GlyphPoints.Count;
        ...
        {
            if (_glyphsLayout == null && _typefaceInfo != null)
            {
                if (HitObject is InlineImage img)
                {
                    ...
                    _glyphsLayout = _typefaceInfo.GetGlyphLayout(new StringCharacterBuffer(Chars));
                    ...
                    _glyphsLayout.GlyphPoints.Clear();
                    _glyphsLayout.GlyphPoints.Add(imgPoint);
                }
                else
                {
                    _glyphsLayout = _typefaceInfo.GetGlyphLayout(new StringCharacterBuffer(Chars));
